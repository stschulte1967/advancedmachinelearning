...
class QLearningAgent(object):
    def __init__(self, num_buckets=10, num_episodes=1000, lr=0.1, min_explore=0.05, discount=1., decay=50):
        ...
        # Q_table has dimension of position, dimension of velocity, dimension of action_space
